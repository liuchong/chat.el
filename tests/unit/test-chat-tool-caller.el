...
(ert-deftest chat-tool-caller-distinguishes-work-plan-from-plan-mode ()
  ...
  (let ((tools
    ...
    (let ((guidance (chat-tool-caller--plan-usage-guidance tools)))
      ...
      (should (string-match-p "fewest items" guidance))
      (should (string-match-p "combine related edits" guidance))
      (should (string-match-p "Complete only the active item" guidance))
